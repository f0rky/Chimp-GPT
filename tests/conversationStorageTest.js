...
async function testConversationStorage() {
  ...
  try {
    ...
    try {
      ...
      const prunedConversations = await conversationStorage.pruneOldConversations(mixedConversations, 1);
