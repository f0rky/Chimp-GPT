...
async function testCircuitBreaker() {
  ...
  try {
    ...
    try {
      ...
      logger.info({ test: 'Retry functionality', success: test2Result.success, retryCount }, 'Test completed');
    } catch (error) {
    ...
    try {
      ...
      logger.info({ test: 'Circuit timeout and reset', success: test4Result.success }, 'Test completed');
    } catch (error) {
